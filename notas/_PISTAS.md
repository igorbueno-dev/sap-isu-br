...
3. O que torna a venda de energia diferente de uma venda comum? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#ge-03) · responda tudo antes de abrir.
...
3. Onde BW aparece no desenho, e por que isso importa para a sua escolha de trilha? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#ge-01) · responda tudo antes de abrir.
...
3. O que muda e o que não muda do ECC para o S/4HANA? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#ge-02) · responda tudo antes de abrir.
...
4. Em qual setor o corte é mais delicado? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#ge-04) · responda tudo antes de abrir.
...
5. Um imóvel foi construído e ninguém se mudou ainda. Quais divisões já têm dado, e quais não? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#md-01) · responda tudo antes de abrir.
...
4. O que acontece se você alterar a tarifa de uma instalação sem olhar a data de validade? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#md-08) · responda tudo antes de abrir.
...
3. Qual objeto liga o mundo comercial ao mundo técnico? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#md-02) · responda tudo antes de abrir.
...
3. Você criou um PN e ele não fatura. Qual a primeira hipótese? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#md-03) · responda tudo antes de abrir.
...
3. A conta do cliente está indo para o endereço errado. Onde você olha primeiro? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#md-04) · responda tudo antes de abrir.
...
3. Onde fica o bloqueio de corte, e onde fica o bloqueio de faturamento? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#md-05) · responda tudo antes de abrir.
...
3. Dois sobrados colados, com números prediais diferentes. Um ou dois objetos de ligação? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#st-01) · responda tudo antes de abrir.
...
3. Um prédio de 40 apartamentos: quantos objetos de ligação e quantos locais de consumo? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#st-02) · responda tudo antes de abrir.
...
3. Conta veio com valor absurdo. Onde você olha antes de suspeitar do cálculo? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#st-03) · responda tudo antes de abrir.
...
3. Medidor trocado no campo, conta ainda com leitura do antigo. Hipótese? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#st-04) · responda tudo antes de abrir.
...
4. Por que não existe transação de criar contrato? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#md-06) · responda tudo antes de abrir.
...
4. Por que Move-In com data retroativa é caro? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#md-07) · responda tudo antes de abrir.
...
4. Se o cliente de uma concessionária não pode trocar de fornecedor, o que o CRM gerencia de fato? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#cs-01) · responda tudo antes de abrir.
...
4. Em que etapa um cliente de concessionária normalmente entra, e por quê? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#cs-02) · responda tudo antes de abrir.
...
4. O que é o S/4 Customer Engagement, e qual sua relação com o CRM clássico? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#cs-03) · responda tudo antes de abrir.
...
5. O que significa dizer que o SAP CRM integra com Salesforce? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#cs-04) · responda tudo antes de abrir.
...
5. Onde o conceito de "prospect" aparece como dado no sistema? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#cs-05) · responda tudo antes de abrir.
...
5. Por que a existência de um middleware prova que CRM e IS-U são sistemas distintos? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#ar-01) · responda tudo antes de abrir.
...
5. Qual a diferença entre `R3AS` e `R3AR2`? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#ar-02) · responda tudo antes de abrir.
...
5. De onde vêm os nomes de tabela desta nota? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#ar-03) · responda tudo antes de abrir.
...
5. Qual objeto a esteira de sete etapas cita sem nunca definir? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#sv-01) · responda tudo antes de abrir.
...
5. Qual tipo de nota é a porta de entrada da Gestão de Perdas? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#wm-01) · responda tudo antes de abrir.
...
6. Alguém diz "registrei a solicitação e nada aconteceu". Qual seu primeiro suspeito? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#wm-02) · responda tudo antes de abrir.
...
6. Por que "histórico completo" é a frente que sustenta perícia? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#dm-01) · responda tudo antes de abrir.
...
6. Uma instalação não faturou e o medidor está corretamente instalado. Qual sua primeira hipótese? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#dm-02) · responda tudo antes de abrir.
...
6. Como um caso de Perdas nasce dentro de WM e de DM? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#pe-01) · responda tudo antes de abrir.
...
6. Por que o recálculo separa TE e TUSD, e o que o prefixo `ISUBR` indica? > **Gabarito:** [`_GABARITOS.md`](_GABARITOS.md#pe-02) · responda tudo antes de abrir.

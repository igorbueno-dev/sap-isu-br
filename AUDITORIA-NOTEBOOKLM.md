...
| **A-11** | **Corrigido** | `caderno/02-BANCADA.md` sai com **223 linhas podadas**, sete seções de meta-estudo removidas. **O arquivo original em `referencia/` continua inteiro** |
